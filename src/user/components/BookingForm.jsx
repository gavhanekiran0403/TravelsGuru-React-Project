  ...
  const handleOnSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        ...
        () =>
          alert(
            "❌ Error! Unable to send booking request. Please try again."
          )
      );
      ...
      >
        ...
        <div className="destination-btn-box">
          <button
            type="button"
            className="dest-btn"
            onClick={() => setSelectedList(international)}
          >
          ...
          <button
            type="button"
            className="dest-btn"
            onClick={() => setSelectedList(domestic)}
          >
            Domestic Packages
          </button>
        </div>
        ...
        <div className="side-by-side">
          ...
          <div className="input-box">
            ...
            <input type="date" name="dept" required />
          </div>
        </div>
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup-box">
            ...
            <p>
              We will contact you shortly on your registered email / mobile
              number.
            </p>
            <button
              type="button"
